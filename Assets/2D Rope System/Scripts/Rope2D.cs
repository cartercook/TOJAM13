...
public class Rope2D
{
    ...
    public void CreateRope(GameObject objectsHolder, GameObject chainObject, Transform pointA, Transform pointB, bool lockFirstChain, bool lockLastChain, bool connectToA, bool connectToB, bool hideEndObjects, bool useLineRenderer, Material ropeMat, float ropeWidth, int ropeLength)
	{
	...
	public IEnumerator CreateRopeWithDelay (GameObject objectsHolder, GameObject chainObject, Transform pointA, Transform pointB, bool lockFirstChain, bool lockLastChain, bool connectToA, bool connectToB, bool hideEndObjects, bool useLineRenderer, Material ropeMat, float ropeWidth, int ropeLength, float delay)
	{
		objHolder = objectsHolder.transform;
